...
from app.services.invoice_importer import ImportResult
...
def mark_upload_job_done(conn: Connection, job_id: str, result: ImportResult) -> None:
    conn.execute(
        ...
        (
            ...
            json.dumps(result.invoice_numbers),
...
def fail_stale_invoice_upload_jobs(conn: Connection) -> None:
